        ...
        <div className="flex items-center justify-between px-4 py-3 max-w-full">
          ...
          <div className="flex items-center gap-3 min-w-0 flex-1">
            <div className="flex items-center justify-center flex-shrink-0">
              <span className="text-primary font-bold text-xl italic transform -skew-x-12">la</span>
            </div>
            <div className="min-w-0 flex-1">
              <div className="font-medium text-foreground text-base truncate">
                {currentPage?.name || "Lamoda"}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center">
              <div className="flex items-center">
                <span className="text-foreground font-light text-4xl italic transform -skew-x-12">la</span>
                <span className="text-foreground font-light text-2xl ml-1">moda</span>
              </div>
            </Link>
